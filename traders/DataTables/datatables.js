 ...
 *   https://datatables.net/download/#dt/dt-1.10.25/af-2.3.7/b-1.7.1/date-1.1.0/fh-3.1.9/rr-1.2.8/sp-1.3.0
 *
 * Included libraries:
 *   DataTables 1.10.25, AutoFill 2.3.7, Buttons 1.7.1, DateTime 1.1.0, FixedHeader 3.1.9, RowReorder 1.2.8, SearchPanes 1.3.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.25/af-2.3.7/b-1.7.1/date-1.1.0/fh-3.1.9/rr-1.2.8/sp-1.3.0",
